...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        ContaCorrente cc1 = new ContaCorrente(1, "Alisson", 1000);
        ...
        ContaCorrente cc2 = new ContaCorrente(2, "Stella", 1000);
        ...
        ContaCorrente cc3 = new ContaCorrente(3, "Joao", 1000);
        ...
        ContaCorrenteEspecial cce1 = new ContaCorrenteEspecial(1, "Alisson", 1000, 5000);
        ...
        ContaCorrenteEspecial cce2 = new ContaCorrenteEspecial(2, "Stella", 1000, 5000);
        ...
        ContaCorrenteEspecial cce3 = new ContaCorrenteEspecial(3, "Joao", 1000, 5000);
