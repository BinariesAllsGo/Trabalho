...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("2 pertence ao conjunto B : " + OperacaoComConjuntos.pertence(2,conjuntoB));
        ...
        System.out.println("7 pertence ao conjunto A: " + OperacaoComConjuntos.pertence(7,conjuntoA));
        System.out.println("5 pertence ao conjunto C: " + OperacaoComConjuntos.pertence(5,conjuntoC));
        ...
        System.out.println("30 pertence ao conjunto C: " + OperacaoComConjuntos.pertence(30,conjuntoC));
        System.out.println("15 pertence ao conjunto D: " + OperacaoComConjuntos.pertence(15,conjuntoD));
        System.out.println("60 pertence ao conjunto D: " + OperacaoComConjuntos.pertence(60,conjuntoD));
